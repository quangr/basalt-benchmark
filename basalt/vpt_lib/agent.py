...
from basalt.vpt_lib.actions import ActionTransformer
from basalt.vpt_lib.policy import MinecraftAgentPolicy
from basalt.vpt_lib.torch_util import default_device_type, set_default_torch_device
...
# Number of different actions in the agent's action space
AGENT_NUM_BUTTON_ACTIONS = 8641
AGENT_NUM_CAMERA_ACTIONS = 121
